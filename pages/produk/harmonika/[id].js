...
import HarmonikaCard from '../../../components/ui/ProductSection/CardProductHarmonika'
  ...
  return (
    <>
      <NextSeo
        ...
        openGraph={{
          type: 'website',
          url: 'https://jualbronjong.online/produk/harmonika',
          title: `${data.name}`,
              ...
              <div className='grid grid-cols-1 py-5 px-4'>
                <div className='pb-4 pr-3'>
                  ...
                  <div className='flex w-full flex-wrap gap-2 pt-2'>
                    {data.specification.size.map((item, index) => (
                      <p
                        ...
                        className={
                          itemIndex === index
                            ? 'w-fit rounded-full bg-brand-primary py-2 px-3  font-brand-primary text-sm font-semibold text-white ring-2 ring-brand-primary transition-all duration-500 ease-in'
                            : 'w-fit rounded-full bg-brand-primary bg-opacity-20 py-2 px-3 font-brand-primary text-sm font-semibold text-brand-primary'
                        }
                      >
                        {item}
                      </p>
      ...
      <div className='hidden h-full w-full md:block'>
        <div className='grid grid-cols-2 gap-x-4 md:min-h-fit md:px-8 md:py-8 lg:gap-x-6 lg:py-9 xl:px-40'>
          ...
          <div className='lg:pt-2'>
            ...
            <div className='border-t-2  border-gray-300'>
              <div className='grid grid-flow-row  py-5 px-4'>
                <div className='pb-4 pr-3'>
                  <h3 className='font-semibold text-gray-600'>
                    Variasi Ukuran
                  </h3>
                  <div className='flex w-full flex-wrap gap-2 pt-2'>
                    {data.specification.size.map((item, index) => (
                      <p
                        ...
                        className={
                          itemIndex === index
                            ? 'w-fit cursor-pointer rounded-full bg-brand-primary py-2  px-3 font-brand-primary text-sm font-semibold text-white ring-2 ring-brand-primary transition-all duration-500 ease-in'
                            : 'w-fit cursor-pointer rounded-full bg-brand-primary bg-opacity-20 py-2 px-3 font-brand-primary text-sm font-semibold text-brand-primary'
                        }
                      >
                        {item}
                      </p>
